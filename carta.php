          ...
          <div class="col s12">
            <div class="cart-box">
              <form>
                ...
                // URL de la API
                $api_url = "https://admin-via-atigliana-production-874f.up.railway.app/api/productos?sort=orden&populate=*&categoria.id=". $categoriaId ."";
                ...
                // URL de la API
                $api_url2 = "https://admin-via-atigliana-production-874f.up.railway.app/api/categorias/".$categoriaId."";
